...
export declare function assets2ts(assetsDir: string): string;
...
export declare function startConvert(dir: string, outDir: string, merge: string, assetsDir?: string): void;
export {};
